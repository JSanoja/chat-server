...
// Luego de aceptar el dominio conecto
  io.of('/161').on('connection', genralSocket => {    
    nameSpace = '/'+genralSocket.handshake.query.idCMSPortal;
    console.log('Conexion al nameSpace ' + nameSpace)    
    let socket = genralSocket;
      // console.log(socket)
      // Usuario conectado
      ...
      console.log(user + ' Se unio desde / '+ room);
